...
/*Exercici 5.1: A partir de la pàgina web proporcionada (ex5_1.html) fes servir el DOM per mostrar per pantalla amb la
funció alert() la següent informació:
Número d'enllaços que hi ha a la pàgina. 
Adreça (URL) del penúltim enllaç.
Numero d'enllaços que ho fan a http://www.uab.cat
Número d'enllaços al tercer paràgraf.*/
...
/*Exercici 5.2:A partir de la pàgina web proporcionada (Ex5_1.html) afegeix un paràgraf nou, amb el text “Hola món!”:
...
/*Exercici 5.3: Afegeix codi JavaScript al fitxer proporcionat (Ex5_4.html) per tal insereixi un nou element a la llista, 
en penúltima posició, amb el text “Salve Mundi!”. A més cal canviar l’estil per defecte de tota la llista i fer que 
no es mostrin els puntets al començament de cada element.*/
...
/* Exercici 5.4: Al document html tens un botó per a aquest exercici que es diu Amagar paràgraf. Quan es cliqui aquest 
botó, cal amagar el paràgraf 2 (display: none) i canviar el text del botó per a que digui Mostrar paràgraf.
Al clicar de nou el botó es desfan els canvis. Es torna a mostrar el paràgraf i al botó torna a posar Amagar paràgraf.*/
